      ...
      <div className="mx-auto flex max-w-6xl flex-col justify-between py-2 font-medium text-white md:flex-row md:items-center">
        <div className="flex items-center justify-between">
          <Link className="z-50" onClick={() => setOpen(false)} href="/">
            <WordMark />
            <span className="sr-only">Dark Design Home Page</span>
          </Link>
        ...
        <div
          className={clsx(
            "fixed bottom-0 left-0 right-0 top-0 z-40 flex transform flex-col items-end gap-4 bg-[#070815] pr-4 pt-14 transition duration-300 ease-in-out motion-reduce:transition-none md:hidden",
